...
mod tests {
    ...
    fn salted() -> String {
        // Hex encoded hashed password to avoid tripping leak detectors
        ...
        String::from_utf8(hex::decode(obfuscated).unwrap()).unwrap()
    }
...
"#
    ...
    fn test_write_entry() {
        ...
        let expected = format!("salty:{}:18912:0:99999:7:::\n", salted());
        let mut buf = Vec::new();
